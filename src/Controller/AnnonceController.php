...
}AnnonceController extends AbstractController
{
...
public function listannonce(AgenceRepository $repository ): Response
{   //$repository= new AuthorRepository();
$annonce=$repository->findAll();
return $this->render('annonce/annoncelist.html.twig',
['annonce'=>$annonce]);
}
